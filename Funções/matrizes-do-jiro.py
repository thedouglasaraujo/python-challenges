...
def soma(primeirofator,segundofator):
  resultado = [[int(primeirofator[i][j]) + int(segundofator[i][j])  for j in range (len(primeirofator[0]))] for i in range(len(primeirofator))]
  return resultado
...
def mult_escalar(matriz):
  resultado = [[int(matriz[i][j]) * int(escalar)  for j in range (len(matriz[0]))] for i in range(len(matriz))]
  return resultado 
