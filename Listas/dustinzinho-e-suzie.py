...
# Caso o valor da soma apareça mais vezes, salvar na lista da senha apenas os índices da primeira ocorrência
senha = senha[0:2]
...
while contador2 != tamanho:
    soma = int(lista[contador][contador2]) + \
        int(lista[(contador+1)][contador2])
    linha3.append(soma)
    contador += 1
