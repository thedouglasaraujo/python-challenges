...
if pegos == True:
  for linha in mapa:
    print(*linha)
  print(f"Ah não, você e {personagem} foram pegos pelo demodog e agora ele vai atravessar o portal e talvez a eleven não consiga salvar todos.")
  
if passou == True:
  mapa[posp1][posp2] = "."
  for linha in mapa:
    print(*linha)
  print(f"UFA!!! Você e {personagem} conseguiram escapar do demodog e incendiar o subsolo, agora a Eleven vai conseguir fechar o portal.")

if passoud == True:
  for linha in mapa:
    print(*linha)
  print(f"Ah não, você e {personagem} não foram rápidos o bastante e o demodog passou pelo portal.")
